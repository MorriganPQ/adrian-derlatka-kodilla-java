...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://morriganpq.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        List<WebElement> elements = driverTrello.findElements(By.xpath("//a[@class=\"board-tile\"]")).stream()
    ...
    private void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().equals(taskName))
                .flatMap(theForm -> theForm.findElements(By.xpath(".//button[@class=\"datatable__button\"]")).stream())
